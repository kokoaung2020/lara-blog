    ...
    <div class="card">
        <div class="card-body">
            ...
            @isset($post->featured_image)
                <img src="{{ asset('storage/500/'.$post->featured_image) }}" height="100" class="rounded  mb-3" alt="">
                {{-- Storage::temporaryUrl($post->featured_image,now()->addMinutes(5)) --}}
            @endisset
            ...
            @foreach($post->photos as $photo)
                <img src="{{ Storage::url('500/'.$photo->name) }}" height="100" class="rounded  mb-3" alt="">
            @endforeach
